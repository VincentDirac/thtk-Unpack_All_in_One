...
NAME
       thanm.old — Touhou sprite archive tool
...
DESCRIPTION
       ...
       thanm.old [-f] -l [version] archive
               Displays a specification of the archive.  The version is neces‐
...
BUGS
       ...
       This version will not create correct TH19 archives, please use the lat‐
       est thanm(1) instead.
